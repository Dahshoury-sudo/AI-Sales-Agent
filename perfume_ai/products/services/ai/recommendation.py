...
9. 🔴🔴 ممنوع تسأل سؤال متابعة في آخر ردك (زي "عايز حاجة تانية؟" أو "محتاج مساعدة؟" أو "عطر معين في بالك؟"). رشح المنتج واشرح ليه يناسبه وخلاص.
{exclusion_note}"""
...
9. 🔴🔴 ممنوع تسأل سؤال متابعة في آخر ردك. رشح المنتج واشرح ليه يناسبه وخلاص. متقولش "عايز حاجة تانية؟" أو "محتاج مساعدة؟".
{exclusion_note}"""
