...
2. أما إذا كان يطلب عطلاً أو طلباً واضحاً ولكنه غير متوفر، فاعتذر بلطف للعميل وأخبره أن العطر غير متوفر حالياً، ثم اسأله عن تفضيلاته العطرية لترشيح بديل مناسب (مثلاً:حضرتك عايزه رجالي ولا حريمي. بتحب الفريش ولا الخشبي؟).
