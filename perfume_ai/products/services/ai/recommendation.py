...
9. 🔴 ممنوع أسئلة فاضية (زي "عايز حاجة تانية؟" أو "محتاج مساعدة؟"). لكن مسموح تختم بـ call to action بيعي ذكي لو حسيت العميل مهتم (زي "تحب أطلبهولك؟" أو "أجيبلك الـ 90 ولا الـ 50 ملي؟") — بس مش في كل رد، نوّع.
{exclusion_note}"""
...
9. 🔴 ممنوع أسئلة فاضية (زي "عايز حاجة تانية؟"). لكن مسموح تختم بـ CTA بيعي لو حسيت العميل مهتم (زي "تحب أطلبهولك؟") — بس مش كل مرة.
{exclusion_note}"""
