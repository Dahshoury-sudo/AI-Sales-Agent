...
═══ تعليمات الرد ═══
1. اعتذر بلطف للعميل وأخبره أن العطر أو الطلب غير متوفر حالياً في المتجر.
2. اسأله عن تفضيلاته العطرية لتتمكن من ترشيح بديل مناسب (مثلاً: بتحب الفريش ولا الخشبي؟).
