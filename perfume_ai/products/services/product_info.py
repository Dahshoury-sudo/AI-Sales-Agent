...
"""
        ...
        instructions = """
═══ تعليمات ═══
1. ارجع لسجل المحادثة أعلاه — لو العميل بيسأل عن منتج اتذكر قبل كده (مثلاً "كام ملي"، "حجمه اي"، "بكام ده")، رد من المعلومات اللي اتقالت في المحادثة وتجاهل قائمة البدائل المقترحة.
2. لو العميل بيسأل عن عطر جديد تماماً واسمه واضح ولكنه غير متوفر لدينا، اعتذر بلباقة وأخبره أنه غير متوفر.
3. إذا كان العطر غير متوفر، رشح له 1-2 من "البدائل المقترحة" أعلاه بشكل جذاب (قل مثلاً "لكن عندنا عطور تانية مميزة جداً ممكن تعجبك").
4. اذكر السعر والحجم الحقيقي للبدائل كما هو مكتوب.
5. لو مش قادر تحدد أي منتج بيسأل عنه حتى من المحادثة، اسأله: "تقصد أي عطر بالظبط يا فندم؟"
6. ❌ ممنوع تخترع أي معلومة أو عطر غير موجود في القائمة المقترحة.
"""
