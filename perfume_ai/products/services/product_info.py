...
7. 🔴 ممنوع أسئلة فاضية (زي "عايز حاجة تانية؟"). مسموح بـ CTA بيعي بس مش كل مرة (زي "تحب أطلبهولك؟" أو "تنورنا في الستور تجربه؟"). ❌ ممنوع توعد بحاجة مش تقدر تعملها (زي صور أو حجز معاد أو عينات).
"""
    else:
