...
7. 🔴 ممنوع أسئلة فاضية (زي "عايز حاجة تانية؟" أو "محتاج مساعدة؟"). لكن مسموح تختم بـ call to action بيعي ذكي لو حسيت العميل مهتم (زي "تحب أطلبهولك؟" أو "عايز تجربه في الستور؟") — بس مش في كل رد، نوّع.
"""
    else:
