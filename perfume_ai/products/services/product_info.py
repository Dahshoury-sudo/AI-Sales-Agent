...
def _named_budget_hint(budget):
    ...
    no marker carries a difference figure — not ✅ and, since the overage stopped being said out
    loud, not ⚠️ either. A ⚠️ size is announced with its printed price and the fixed sentence
    "أعلى حاجة بسيطة من ميزانيتك", never with a delta.
    """
    if budget is None:
        return ""
    return (
        f"\n🔴 العميل قال إن ميزانيته {int(budget)} جنيه، وكل سعر في البيانات فوق جانبه علامة "
        "(✅ داخل الميزانية / ⚠️ أعلى حاجة بسيطة / ❌ أعلى بكتير). العلامة دي محسوبة وهي الحكم "
        "الوحيد على الميزانية: ❌ ممنوع تحسب الفرق بنفسك، وممنوع تقول رقم فرق خالص — مفيش رقم فرق "
        "في البيانات من الأصل. لو الحجم عليه ⚠️، قول سعره المكتوب وقول \"أعلى حاجة بسيطة من "
        "ميزانيتك\" بالحرف وبس. وحجم عليه ✅ يبقى داخل الميزانية خلاص — ممنوع تقول عنه \"أعلى من "
        "ميزانيتك\" ولا \"أعلى حاجة بسيطة\" ولا \"أعلى شوية\".\n"
...
def _alternatives_budget_hint(budget):
    ...
    return (
        ...
        "الأول — فابدأ بيه. ولو الحجم عليه ⚠️، قول سعره المكتوب وقول \"أعلى حاجة بسيطة من "
        "ميزانيتك\" بالحرف — ❌ ممنوع تذكر الفرق بكام ولا تحسبه. ولو كل البدائل عليها ⚠️ أو ❌، "
        "قول للعميل بصراحة إن اللي عندنا أعلى من الرقم اللي قاله واذكر أرخص حاجة عندنا بسعرها. "
        "❌ ممنوع تعرض سعر أعلى من ميزانيته من غير ما تقول إنه أعلى، وممنوع تسكت وتسيبه من غير أي "
        "اقتراح.\n"
    )
