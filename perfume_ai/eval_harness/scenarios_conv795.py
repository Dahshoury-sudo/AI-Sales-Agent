...
SCENARIOS = [
    {
        ...
        "probe": (
            ...
            "❌ CRITICAL: saying الكساندريا 2 or لادور بخور is 'مش موجود عندنا' / 'مش متوفر' / "
            "apologising for not carrying it. The system not finding a name is not the shop not "
            "stocking it, and only the owner knows the difference — the reply is 'لحظة أتأكدلك' "
            "and nothing more. "
            ...
            "The customer is chasing the answer to turn 1 — say you are still checking and that "
            "you will come back to them. A price list for a perfume they never asked about is not "
            "an answer to being asked to check. "
            ...
            "citing the incense/olibanum note each one actually has, while the deferral on لادور "
            "بخور stays open and honest. Turns 1 and 3 asked about availability only, so a size "
            "and price list is unrequested on both. ❌ Never quote a price for any perfume that "
            "is not one of the six figures above."
        ),
    }
]
